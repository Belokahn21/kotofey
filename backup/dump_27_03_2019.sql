...
--
-- Table structure for table `cfg_accessory`
--

DROP TABLE IF EXISTS `cfg_accessory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cfg_accessory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cfg_accessory`
--

LOCK TABLES `cfg_accessory` WRITE;
/*!40000 ALTER TABLE `cfg_accessory` DISABLE KEYS */;
INSERT INTO `cfg_accessory` VALUES (1,'Портмоне',NULL,1553235588,1553235588),(2,'Обложка на паспорт',NULL,1553235588,1553235588),(3,'Ремень',NULL,1553235588,1553235588);
/*!40000 ALTER TABLE `cfg_accessory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cfg_color`
--

DROP TABLE IF EXISTS `cfg_color`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cfg_color` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cfg_color`
--

LOCK TABLES `cfg_color` WRITE;
/*!40000 ALTER TABLE `cfg_color` DISABLE KEYS */;
INSERT INTO `cfg_color` VALUES (1,'Чёрный','',1553237052,1553237052),(2,'Коричнеый','',1553237052,1553237052);
/*!40000 ALTER TABLE `cfg_color` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cfg_leather`
--

DROP TABLE IF EXISTS `cfg_leather`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cfg_leather` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `description` text,
  `image` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cfg_leather`
--

LOCK TABLES `cfg_leather` WRITE;
/*!40000 ALTER TABLE `cfg_leather` DISABLE KEYS */;
INSERT INTO `cfg_leather` VALUES (1,'Юфть(«Русская кожа»)','мягкая кожа растительного дубления, изготавливается из шкур крупного рогатого скота, лошадей, свиней. Юфть бывает разной толщины. Свойства юфти определяются видом сырья, его качеством и способом переработки в кожу. Юфть из шкур крупного рогатого скота называется яловочной, из конских и свиных шкур соответственно — конской и свиной.','',1553236903,1553236903),(2,'Краст','кожа полученная с помощью барабанного крашения, поверхностная отделка у таких кож отсутствует. Поэтому они имеют естественную лицевую поверхность. Так как отделка лицевой стороны отсутствует это дает возможность избежать множество пороков связанных с отслоением. Обработка современными методами придает красту качества гидрофобности, а специальный режим окраски — сквозной прокрас. Качественно выделанный краст сложно отличить от кож, которые имеют гладкую лицевую повехность. Производится из шкур крупного рогатого скота.','',1553236903,1553236903),(3,'Шевро','изготавливается с помощью хромового дубления из козьих шкур. Кожа мягкая, эластичная, плотная и прочная, поверхность кожи имеет мелкие морщинки, формирующие рисунок.','',1553236957,1553236957),(4,'Замша','вырабатывается жировым дублением из оленьих, лосиных, козлиных шкур. Кожа мягкая, рыхлая, прочная с низким ворсом на лицевой поверхности.\r\n\r\nЗамша более “капризна” в уходе, чем кожа. Она труднее чистится, быстрее теряет первоначальный цвет, от влаги на ней могут образовываться трудноустранимые пятна и разводы. Также она может покрываться в некоторых местах беловатым налетом. Учитывая вышеперечисленные особенности, замша применяется преимущественно для изготовления более нарядной одежды и обуви, предназначенной «на выход» и подверженной не слишком частой эксплуатации.','',1553236957,1553236957);
/*!40000 ALTER TABLE `cfg_leather` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `discount` VALUES (1,1,6.25),(17,10,1.25),(16,9,1.25),(15,8,1.25),(14,7,1.25),(13,6,1.25),(12,5,1.25);
...
INSERT INTO `pages` VALUES (1,'Что такое кожа Crazy Horse','cto-takoe-koza-crazy-horse',500,1,'','/web/upload/59b514174bffe4ae402b3d63aad79fe0.jpg','<p>Crazy Horse ― это прочная высококачественная кожа крупного рогатого скота (не смотря на название не обязательно лошади). Эта кожа характерна своим эффектом состаривания. Интересный эффект образуется благодаря специальной обработке: на шлифованный краст с помощью нагрева наносится смесь восков с высокой температурой плавления и специальные присадки. После обработки таким способом кожа становится темнее, нежели была изначально. В результате этого кожа Crazy Horse меняет цвет в местах залома, изгиба или натяжения. В этих местах кожа становится более светлой</p>\r\n',NULL,'','',1552977870,1553142349),(2,'Что такое кожа Краст','cto-takoe-koza-krast',500,1,'','/web/upload/84b7cfcf24514195688ec44ae8244d4a.jpg','<p>Краст&nbsp;- это общее название натуральной кожи без лицевой отделки, в основном крупного рогатого скота. Кожа краст сохраняет естественный рисунок характерный для кожи.</p>\r\n\r\n<p>Он не тронут глаженьем, шлифовкой и тиснением, поэтому можно смело сказать, что кожа остается живой, сохраняя даже способность загорать на солнце и &laquo;заживлять&raquo; мелкии царапины Крат проходит барабанное крашение со специальным режимом, называемом сквозным прокрасом, это позволяет получить равномерный цвет не только на поверхности но и по всей глубине. Можно не бояться, что окрашенная лицевая сторона отслоится или потрескается. На шве кожи вы не заметите сильного различия цвета между лицом и самим срезом. Поскольку крашение происходит под давлением на обороте может оставаться легкий отпечаток сетки барабана. Для придания водоотталкивающей способности мы вручную обрабатываем поверхность натуральным воском. Сочетание воск и трения позволяет добиться различных оттенков кожи и винтажных эффектов.</p>\r\n\r\n<p>При обработке воском не меняется рисунок, так бережно сохраненный при крашении, и позволяет не потерять неповторимое ощущение живой кожи. Изделия сырьем, для которых служил обработанный воском краст очень долговечны, так как мелкие царапины возникающие при использовании изделий, выравниваются и исчезают сами от трения. Со временем в местах наибольшего трения цвет кожи может меняться на более темный, придавая вещи свой неповторимый шарм и ощущение благородной старины.</p>\r\n',NULL,'','',1552977882,1553142361);
...
INSERT INTO `status_order` VALUES (1,'Товар отправлен клиенту',0,0),(2,'Заказ создан',0,0);
...
INSERT INTO `support_status` VALUES (1,'Обращение обрабатывается',500,1553541254,1553541254);
...
INSERT INTO `user` VALUES (1,'_a4LWmjP8gifqd9c-YuLhmUz5EAkeSrd',NULL,'popugau@gmail.com',89059858726,'$2y$13$DA/3aZqa5PCvBRMaJv0oTOEX1FXHpsBZjdV/d7aThUf5L8QQBQWMW','/web/upload/4f6d5610786866c111c23996df298b7f.jpg',111815168,NULL,1,'Васин','Константин','Викторович',NULL,1549015106,1552545338),(10,'FBwsZD8g0KymlkCDGacgT8oQFje6Vls9',NULL,'popugau22@gmail.com',88005557777,'$2y$13$Qb44nBOZPdunsr2jxRF22uoNzlR2sp0AIHIkvBU/ceVdS876beFmq',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1553668960,1553668960);
...
INSERT INTO `user_billing` VALUES (6,6,'Барнаул','Просторная','5','99',1553666397,1553666397),(3,1,'Барнаул','Весенняя','4','55',1551866451,1551866479),(5,5,'asdasd','asdasd','11','11',1553666195,1553666195),(7,7,'Барнаул','Весенняя','4','55',1553666737,1553666737),(8,8,'asdasd','sadasd','8','8',1553668237,1553668237),(9,9,'Барнаул','Просторная','1','1',1553668672,1553668672),(10,10,'Барнаул','Просторная','4','55',1553668961,1553668961);
...
-- Dump completed on 2019-03-27 10:00:02

...
INSERT INTO `auth_item` VALUES ('Administrator',1,'Управление сайтом и всем содержимым',NULL,NULL,1548181899,1548181899),('Developer',1,'Создатель всего, что ты видишь',NULL,NULL,1548181923,1548181923),('Master',1,'Мастер',NULL,NULL,1553654336,1553654336),('Owner',1,'Владелец',NULL,NULL,1554739935,1554739935),('Support',1,'Отдел поддержки',NULL,NULL,1551199426,1551199426),('test_admin',1,'test',NULL,NULL,1554868779,1554868779),('test_admin2',1,'qwd',NULL,NULL,1554870753,1554870753),('viewProduct',2,'Просмотр товара',NULL,NULL,1552546595,1552546595);
...
INSERT INTO `auth_item_child` VALUES ('Administrator','test_admin'),('test_admin','test_admin2');
...
INSERT INTO `site_settings` VALUES (1,'Наценка товаров(%)','saleup','text','20'),(2,'Присылать уведомления на страницу Вконтакте','need_notify_to_vk','checkbox','N'),(3,'ID пользователя Вконтакте','vk_id','text','111815168'),(4,'Размер каталога резервных копий(МБ)','backup_catalog_size','text','512');
...
-- Dump completed on 2019-04-10 10:00:01

...
INSERT INTO `site_settings` VALUES (1,'Наценка товаров','saleup','text','20'),(2,'Прсылать уведомления на страницу Вконтакте','need_notify_to_vk','checkbox','N'),(3,'ID пользователя Вконтакте','vk_id','text','');
...
-- Dump completed on 2019-04-05 10:00:02

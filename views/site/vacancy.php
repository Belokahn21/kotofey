...
<?php else: ?>
    <strong>Вакансии отстуствуют. Загляните к нам позже!, но если считаете, что ваша кандидатура очень сильна нам нужна, то отправьте своё резюме на <a href="mailto:<?= Yii::$app->params['email']['job']; ?>">электронный аддрес</a></strong>
<?php endif; ?>

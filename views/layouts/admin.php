...
<div class="page-wrapper">
    <nav class="dashboard-left-sidebar">
        ...
        <div class="current-profile">
            <div class="avatar-wrap">
                <img class="current-profile__avatar" src="<?=((!empty($user->avatar)) ? $user->avatar: "/web/upload/images/boy.png");?>" alt="Аватар пользователя <?=$user->email;?>" title="Аватар пользователя <?=$user->email;?>">
            </div>
        ...
        <div class="panel-menu-wrap">
            ...
            <ul class="panel-menu">
                ...
                <li class="panel-menu__item"><a href="/admin/"><i class="fa fa-shopping-cart"></i>Магазин</a>
                    <ul>
                        <li class="panel-menu__item sub"><a href="/admin/order/">Заказы<span class="count"><?= Order::find()->count() ?></span></a>
                            <ul>
                ...
                <li class="panel-menu__item"><a href="/admin/catalog/"><i class="fas fa-cookie"></i>Товары<span class="count"><?= Product::find()->count() ?></span></a>
                    <ul>
                ...
                <li class="panel-menu__item"><a href="/admin/support/"><i class="far fa-life-ring"></i>Поддержка<span class="count"><?= Tickets::find()->count() ?></span></a>
                    <ul>
                ...
                <li class="panel-menu__item"><a href="/admin/user/"><i class="fa fa-user-alt"></i>Пользователи<span class="count"><?= User::find()->count(); ?></span></a>
                    <ul>
                ...
                <li class="panel-menu__item"><a href="/admin/pages/"><i class="fas fa-file"></i></i>Страницы<span class="count"><?= Pages::find()->count(); ?></span></a>
                    <ul>

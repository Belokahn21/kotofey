...
use app\widgets\notification\Alert;
use app\modules\delivery\models\search\DeliveryServiceSearchForm;
use app\modules\site\controllers\MainBackendController;

class ServicesBackendController extends MainBackendController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new DeliveryServiceSearchForm();

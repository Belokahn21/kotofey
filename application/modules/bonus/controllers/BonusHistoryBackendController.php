...
class BonusHistoryBackendController extends MainBackendController
{
    public $modelClass = 'app\modules\bonus\models\forms\UserBonusHistoryForm';
    ...
    public function actionIndex()
    {
        ...
        $bonusAccount = UserBonus::find()->orderBy(['created_at' => SORT_DESC])->all();

...
<div class="page">
    ...
    <div class="page__group-row">
        <div class="page__left">
            ...
            <div class="page__text">Доставка заказа в день покупки возможна <strong>при наличии товара</strong> и <strong>заказе до 13.00</strong>.</div>
            <div class="page__text">Доставляем по городу Барнаулу, поселки: Власиха, Лесной, Центральный, Южный, Авиатор, Спутник.</div>
            <div class="page__text">Доставка в Новоалтайск, Казеную заимку, Гоньбу, Научный городок +150 рублей к любой сумме заказа</div>
            <div class="page__text">Доставка в ЗАТО Сибирский +300 рублей к любой сумме заказа.</div>
            <div class="page__text">Отправляем заказы <strong>по всей России</strong> различными транспортными компаниями и Почтой России. На текущий момент мы сотрудничаем с ТК СДЭК, DPD.</div>
            <div class="page__text">Время и сумма доставки для каждого заказа индивидуальна поэтому перед покупкой воспользуйтесь калькулятором расчёта предоставленный на сайтах транспортных компаний либо обратитесь к нам за консультацией по телефону <a href="tel:<?= SiteSettings::getValueByCode('phone_2'); ?>" class="js-phone-mask-8800"><?= SiteSettings::getValueByCode('phone_2'); ?></a>. Мы с радостью проконсультируем по срокам и стомости доставки.</div>

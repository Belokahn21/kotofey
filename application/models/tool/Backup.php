...
class Backup
{
    ...
    {
        $fileName = date('d_m_Y');
        $this->name_file = "dump_" . $fileName . ".sql";
        $pathToSave = \Yii::getAlias('@app') . $this->name_dir_dumps . $this->name_file;
     ...
     * @return string
     */
    public function getNameDirDumps()
    {
        return $this->name_dir_dumps;
    }
}
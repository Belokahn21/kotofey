    ...
    render() {
        ...
        return <div className="checkout-form-variants__item-wrap">
            <div className="checkout-form-variants__item">
                <input onSelect={this.props.handleSelectPayment.bind(this)} className="checkout-form-variants__input" type="radio" id={uniq} name="Order[payment_id]" defaultValue={element.id}/>

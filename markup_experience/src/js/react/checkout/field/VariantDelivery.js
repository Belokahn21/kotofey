...
class VariantDelivery extends Component {
    ...
    render() {
        const element = this.props.element, uniq = Math.random().toString(36).substring(7) + element.id + 'd';
        return <div className="checkout-form-variants__item-wrap">
            <div className="checkout-form-variants__item">
                <input onChange={this.props.handleSelectDelivery.bind(this)} className="checkout-form-variants__input" type="radio" id={uniq} name="Order[delivery_id]" defaultValue={element.id}/>

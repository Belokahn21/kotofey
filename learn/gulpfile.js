...
const config = {
	paths: {
		...
		js: {
			...
			application_frontend: '../inc/local/templates/adelfo/assets/js/',
		},
		image: {
			...
			application_frontend: '../inc/local/templates/adelfo/assets/images/',
		},
		copy: {
